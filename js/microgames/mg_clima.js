(function () {
    ...
    mg.init = function () {
        ...
        var numMachines = Math.min(12, 4 + diffLevel); // Starts at 4, adds 1 per level, max 12
        goal = Math.min(numMachines, 2 + diffLevel); // Ask to turn off 2 initially, +1 per level
        ...
        console.log("Minijuego Clima: Objetivo " + goal + " de " + numMachines + " máquinas | Tiempo: " + this.maxTime.toFixed(2));
    }
